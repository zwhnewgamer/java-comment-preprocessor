...
public class SoundManager
{
    ...
    /**
     * Ēąļóńź ļšīčćšūāąķč˙ ēāóźą
     *
     * @param _index čķäåźń ļšīčćšūāąåģīćī ēāóźą
     * @param _count źīėč÷åńņāī ļīāņīšåķčé
     */
    public synchronized static final void playSound(final int _index, final int _count)
    {
        ...
        try
        {
           ...
           //$while(lg_PlayerInIniting){Thread.yield();}
            ...
            if (i_lastStarted >= 0)
            {
                // Ļšīāåšźą ķą īźīķ÷ąķčå ļšīčćšūāąķč˙ ļšåäūäółåćī ēāóźą
            ...
            //#if VENDOR=="SAMSUNG"
            // Źīššåźöč˙ šåäźīé īųčįźč ļīėó÷åķč˙ ņåźółåćī āšåģåķč
            // ēąōčźńčšīāąķķīé ķą X100, E700
